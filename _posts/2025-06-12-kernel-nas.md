...
[Melzer, Reiter, & Bischof, 2001](#ref-thomas2001kcca)) between the
inputs, $\mathbf{X}$, and the outputs, $\mathbf{Y}$, with respect to the
...
on NAS benchmarks: NAS-Bench-201 ([Dong & Yang,
2020](#ref-dong2020nasbench201)) and DARTS ([Liu, Simonyan, & Yang,
...
space ([Poyser & Breckon, 2024](#ref-poyser_2024_nas-review)). Most
methods for NAS incur a high search cost in the form of (partially)
...
of these are NTK-based methods like TE-NAS ([Chen, Gong, & Wang,
2021](#ref-chen2020tenas)), which uses the condition number of the NTK
Gram Matrix, and KNAS ([Xu et al., 2021](#ref-pmlr-v139-xu21m)), which
uses the mean of the Matrix's entries. These studies report competitive
performances on real-world computer vision tasks in NAS benchmarks
([Dong & Yang, 2020](#ref-dong2020nasbench201); [Liu et al.,
2019](#ref-liu2018darts); [Ying et al., 2019](#ref-ying19nasbench101)).
...
MSE ([Englisch & Hiemstra, 1994](#ref-englisch_1994_corr-mse)).
Accordingly, we define the score for architecture $\mathbf{A}$ as
...
Empirical Neural Tangent Kernel (NTK) ([Jacot, Gabriel, & Hongler,
...
where $\mathcal{K}$ denotes the NN-GP kernel ([G. Matthews, Rowland,
Hron, Turner, & Ghahramani,
...
([He, Lakshminarayanan, & Teh,
2020](#ref-bobby_2020_bayesian-ensembles-ntk)),
...
Importantly, in my Bachelor's thesis project ([Hemachandra, Dai, Singh,
Ng, & Low, 2023](#ref-hemachandra23a)), we showed that the ratio between
...
Herbrich, Smola, Bousquet, & Schölkopf, 2005](#ref-gretton05a)). A
common practice is to add some regularization to this problem by
penalizing rougher witness functions, $f$ and $g$, which yields the
...
Hilbert-Schmidt Independence Criterion (HSIC) ([Gretton, Bousquet,
Smola, & Schölkopf, 2005](#ref-gretton2005hsic)), and the Kernel Target
Alignment (KTA) ([Cortes, Mohri, & Rostamizadeh,
2012](#ref-cortes12kta)), as proposed in ([Chang, Kruger, Kustra, &
Zhang, 2013](#ref-chang13hsic)).
...
::: {#ref-chang13hsic .csl-entry}
Chang, B., Kruger, U., Kustra, R., & Zhang, J. (2013). Canonical
correlation analysis based on hilbert-schmidt independence criterion and
centered kernel target alignment. In *Proceedings of the 30th
international conference on machine learning* (Vol. 28, pp. 316--324).
Atlanta, Georgia, USA: PMLR. Retrieved from
<https://proceedings.mlr.press/v28/chang13.html>
:::

::: {#ref-chen2020tenas .csl-entry}
...
::: {#ref-cortes12kta .csl-entry}
Cortes, C., Mohri, M., & Rostamizadeh, A. (2012). Algorithms for
learning kernels based on centered alignment. *Journal of Machine
Learning Research*, *13*(28), 795--828. Retrieved from
<http://jmlr.org/papers/v13/cortes12a.html>
:::

::: {#ref-dong2020nasbench201 .csl-entry}
...
learning representations (ICLR)*. Retrieved from
<https://openreview.net/forum?id=HJxyZkBKDr>
:::

::: {#ref-englisch_1994_corr-mse .csl-entry}
Englisch, H., & Hiemstra, Y. (1994). The correlation as cost function in
neural networks. In *Proceedings of 1994 IEEE international conference
on neural networks (ICNN'94)* (Vol. 5, pp. 3170--3172 vol.5).
doi:[10.1109/ICNN.1994.374741](https://doi.org/10.1109/ICNN.1994.374741)
:::

::: {#ref-matthews2018gaussianprocessbehaviourwide .csl-entry}
G. Matthews, A. G. de, Rowland, M., Hron, J., Turner, R. E., &
Ghahramani, Z. (2018). Gaussian process behaviour in wide deep neural
networks. Retrieved from <https://arxiv.org/abs/1804.11271>
:::

::: {#ref-gretton2005hsic .csl-entry}
Gretton, A., Bousquet, O., Smola, A., & Schölkopf, B. (2005). Measuring
statistical dependence with hilbert-schmidt norms. In S. Jain, H. U.
Simon, & E. Tomita (Eds.), *Algorithmic learning theory* (pp. 63--77).
Berlin, Heidelberg: Springer Berlin Heidelberg.
:::

::: {#ref-gretton05a .csl-entry}
Gretton, A., Herbrich, R., Smola, A., Bousquet, O., & Schölkopf, B.
(2005). Kernel methods for measuring independence. *Journal of Machine
Learning Research*, *6*(70), 2075--2129. Retrieved from
<http://jmlr.org/papers/v6/gretton05a.html>
:::

::: {#ref-bobby_2020_bayesian-ensembles-ntk .csl-entry}
He, B., Lakshminarayanan, B., & Teh, Y. W. (2020). Bayesian deep
ensembles via the neural tangent kernel. In *Advances in neural
information processing systems* (Vol. 33, pp. 1010--1022). Curran
Associates, Inc. Retrieved from
<https://proceedings.neurips.cc/paper_files/paper/2020/file/0b1ec366924b26fc98fa7b71a9c249cf-Paper.pdf>
:::

::: {#ref-hemachandra23a .csl-entry}
Hemachandra, A., Dai, Z., Singh, J., Ng, S.-K., & Low, B. K. H. (2023).
Training-free neural active learning with initialization-robustness
guarantees. In *Proceedings of the 40th international conference on
machine learning* (Vol. 202, pp. 12931--12971). PMLR. Retrieved from
<https://proceedings.mlr.press/v202/hemachandra23a.html>
:::

::: {#ref-jacot_2018_ntk .csl-entry}
...
::: {#ref-lee_2019_wide-nets-linear .csl-entry}
Lee, J., Xiao, L., Schoenholz, S., Bahri, Y., Novak, R., Sohl-Dickstein,
J., & Pennington, J. (2019). Wide neural networks of any depth evolve as
linear models under gradient descent. In *Advances in neural information
processing systems* (Vol. 32). Curran Associates, Inc. Retrieved from
<https://proceedings.neurips.cc/paper_files/paper/2019/file/0d1a9651497a38d8b1c3871c84528bd4-Paper.pdf>
:::

::: {#ref-liu2018darts .csl-entry}
Liu, H., Simonyan, K., & Yang, Y. (2019). DARTS: Differentiable
architecture search. In *International conference on learning
representations*. Retrieved from
<https://openreview.net/forum?id=S1eYHoC5FX>
:::

::: {#ref-thomas2001kcca .csl-entry}
Melzer, T., Reiter, M., & Bischof, H. (2001). Nonlinear feature
extraction using generalized canonical correlation analysis. In G.
Dorffner, H. Bischof, & K. Hornik (Eds.), *Artificial neural networks
--- ICANN 2001* (pp. 353--360). Berlin, Heidelberg: Springer Berlin
Heidelberg.
:::

::: {#ref-poyser_2024_nas-review .csl-entry}
Poyser, M., & Breckon, T. P. (2024). Neural architecture search: A
contemporary literature review for computer vision applications.
*Pattern Recognition*, *147*, 110052.
doi:<https://doi.org/10.1016/j.patcog.2023.110052>
:::

::: {#ref-pmlr-v139-xu21m .csl-entry}
Xu, J., Zhao, L., Lin, J., Gao, R., Sun, X., & Yang, H. (2021). KNAS:
Green neural architecture search. In M. Meila & T. Zhang (Eds.),
*Proceedings of the 38th international conference on machine learning*
(Vol. 139, pp. 11613--11625). PMLR. Retrieved from
<https://proceedings.mlr.press/v139/xu21m.html>
:::

::: {#ref-ying19nasbench101 .csl-entry}
Ying, C., Klein, A., Christiansen, E., Real, E., Murphy, K., & Hutter,
F. (2019). NAS-bench-101: Towards reproducible neural architecture
search. In *Proceedings of the 36th international conference on machine
learning* (Vol. 97, pp. 7105--7114). Long Beach, California, USA: PMLR.
Retrieved from <http://proceedings.mlr.press/v97/ying19a.html>
:::
:::::::::::::::::::::
